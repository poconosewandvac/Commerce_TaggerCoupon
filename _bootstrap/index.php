...
if (!createObject('modNamespace',array(
    'name' => 'commerce_taggercoupon',
    'path' => $componentPath.'/core/components/commerce_taggercoupon/',
    'assets_path' => $componentPath.'/assets/components/commerce_taggercoupon/',
),'name', false)) {
    echo "Error creating namespace commerce_taggercoupon.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_taggercoupon.core_path',
    'value' => $componentPath.'/core/components/commerce_taggercoupon/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_taggercoupon',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_taggercoupon.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_taggercoupon.assets_path',
    'value' => $componentPath.'/assets/components/commerce_taggercoupon/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_taggercoupon',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_taggercoupon.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_taggercoupon/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_taggercoupon.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_taggercoupon',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_taggercoupon.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_taggercoupon.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_taggercoupon/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_taggercoupon/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'PoconoSewVac\\TaggerCoupon\\Modules\\', $modulePath);
